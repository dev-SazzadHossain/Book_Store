...
import { useDeleteBookMutation } from "../../features/api/bookApiSlice";
import { toast } from "react-toastify";
import { Link } from "react-router-dom";

const Book = ({ book }) => {
  const { author, name, thumbnail, featured, price, rating, id } = book;
      ...
      <div class="flex-1 h-full pr-2 pt-2 flex flex-col">
        <div class="flex items-center justify-between">
          ...
          <div class="text-gray-500 space-x-2">
            ...
            <button onClick={() => handelDelete(id)} class="lws-deleteBook">
              <svg
                fill="none"
                viewBox="0 0 24 24"
                stroke-width="1.5"
